...
@endif
        <form class="layui-form" action="{{url('/brand/update/'.$brand->brand_id)}}" method="post" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="brand_url" lay-verify="title" autocomplete="off" placeholder="请输入品牌URL" value="{{$brand->brand_url}}"   class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="brand_desc" lay-verify="title" autocomplete="off" placeholder="请输入品牌简介" value="{{$brand->brand_desc}}"  class="layui-input">
                    </div>
                </div>
                <div align="center">
